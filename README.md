...
* [Shutdown CPU or GPU drivers destroyer](#Shutdown-CPU-or-GPU-drivers-destroyer)
...
### Shutdown CPU or GPU drivers destroyer:
...
1) You need to **enable hardware virtualization** in your **UEFI** or **BIOS**.<br>
...
4) Update **WSL** and set WSL 2 as the default version.
    ```powershell
    wsl --update
